...
const BoardComponent: React.FC<BoardProps> = ({
  ...
  const lightBoardClass = 'border border-neutral-300/90 bg-neutral-100/85'
  const darkBoardClass = '  dark:border-neutral-800 dark:bg-neutral-900/70'

  const boardClassName = cn(baseBoardClass, lightBoardClass, darkBoardClass, disabled && 'opacity-75')
